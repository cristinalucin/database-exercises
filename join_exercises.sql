...
# 7
/*
SELECT d.dept_name department_name, AVG(s.salary) salary
FROM dept_emp de
...
SELECT e.first_name first_name, e.last_name last_name
FROM employees e
...
SELECT e.first_name first_name, e.last_name last_name, s.salary salary, d.dept_name department_name
FROM employees e
...
/*
SELECT d.dept_name department_Name, ROUND(AVG(s.salary)) average_salary
FROM salaries s
